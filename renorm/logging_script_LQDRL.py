...
def plot_uav_trajectory(env, uav_trajectory, layer, ep, t, plots_dir):
    fig = plt.figure()
...
# === Save CSVs ===
def save_csvs(dfs, experiment_dir):
    ...
    for g in [2, 4, 6, 8]:
        ...
        for min_val in min_list:
            for max_val in max_list[0:it]:
                ...
                exp_name = config_string(m, g, num_eves, max_val, max_val, zmax)
                ...
                for ep in range(episodes):
                    ...
                    plot_uav_trajectory(env, ep_uav_trajectory, m, ep, i, plots_dir)
